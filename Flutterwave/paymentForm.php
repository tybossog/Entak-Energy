...
<body>
<?php
$email = $firstName = $lastName = $address = $phone = $descTitle = "";
$desc = $currency = $country = $amount = $mode = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $amount = test_input($_POST["tprice"]);
  $desc = test_input($_POST["transactionDesc"]);
  $currency = "NGN";
  $descTitle = "Gas Purchase";
  $country = "Nigeria";
  $mode = "card";
...
<form method="POST" action="processPayment.php" id="paymentForm">
    ...
    <input type="hidden" name="payment_options" value="bank transfer"/>
    <!-- Can be card, account, ussd, qr, mpesa, mobilemoneyghana  (optional) -->
    <input type="hidden" name="description" value="gas purchase"/>
    ...
    <input type="hidden" name="title" value="$descTitle"/>
    <!-- Replace the value with your transaction title (optional) -->
    <input type="hidden" name="country" value="Nigeria"/> <!-- Replace the value with your transaction country -->
    <input type="hidden" name="currency" value="NGN"/> <!-- Replace the value with your transaction currency -->
    <input type="hidden" name="email" value="oganlamichael51@gmail.com"/> <!-- Replace the value with your customer email -->
    <input type="hidden" name="firstname" value="michael"/>
    <!-- Replace the value with your customer firstname (optional) -->
    <input type="hidden" name="lastname" value="oganla"/>
    <!-- Replace the value with your customer lastname (optional) -->
    <input type="hidden" name="phonenumber" value="09080234555"/>
